      ...
      <main className="max-w-7xl mx-auto px-8 py-10">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          ...
          {noticias.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              {noticias.map((n, idx) => (
                <Link key={n.anuncioId ?? idx} href="/dashboard/noticias" className="flex items-start justify-between border border-gray-100 rounded-lg px-4 py-3 hover:bg-gray-50/60 transition-colors">
